...
aws ecr get-login-password | docker login --username AWS --password-stdin 337392631707.dkr.ecr.us-east-1.amazonaws.comdocker tag zootle 337392631707.dkr.ecr.us-east-1.amazonaws.com/zootle
